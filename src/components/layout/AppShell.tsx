  ...
  return (
    <div className="flex h-full flex-col bg-sidebar border-r border-sidebar-border/60">
      ...
      <Link to="/dashboard" className="flex h-16 shrink-0 items-center px-4 transition-opacity hover:opacity-80">
        <img src={logo} alt={appBrand.name} className="h-auto max-h-11 w-full rounded-md object-contain brightness-0 dark:invert" />
      </Link>
                      ...
                      <NavLink
                        ...
                        className={({ isActive }) =>
                          cn(
                            ...
                            isActive
                              ? 'bg-sidebar-primary/20 text-sidebar-foreground font-semibold'
